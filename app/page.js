              ...
              {displayProjects.map((project, index) => (
                ...
                >
                  <div className={`rounded-2xl overflow-hidden transition-all duration-300 ease-out ${
                    ...
                    {/* Project Content */}
                    <div className="p-6">
                      <h3 className="text-lg font-medium text-gray-900 mb-3 group-hover:text-gray-800 transition-colors duration-300">
                        {project.title}
                      </h3>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <Link
                          href="/projects"
                          className="text-gray-600 hover:text-gray-900 text-xs transition-colors font-medium"
                        >
                          View Details →
                        </Link>
                      </div>
