...
export default function Toast({ 
  ...
  const getToastStyles = () => {
    switch (type) {
      ...
      case 'warning':
        return 'bg-gradient-to-r from-orange-50 to-amber-50 text-orange-800 border-orange-300 shadow-orange-100';
      case 'info':
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className={`
            flex items-center space-x-3 p-4 rounded-xl shadow-lg border backdrop-blur-sm
            ${getToastStyles()}
          `}>
