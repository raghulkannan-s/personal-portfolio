...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>New Portfolio Contact</title></head>
<body style="font-family: Arial, sans-serif; background: #f8fafc; padding: 0; margin: 0; line-height: 1.5;">
  <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.08); border: 1px solid rgba(0,0,0,0.06);">
    <div style="background: linear-gradient(135deg,#1a1a1a 0%,#000 100%); padding: 32px 24px; text-align: center;">
      <div style="display: inline-block; width: 56px; height: 56px; background: rgba(255,255,255,0.1); border-radius: 12px; margin-bottom: 16px; line-height: 56px; text-align:center;">
        <span style="color: #d4af37; font-size: 24px;">✉</span>
      </div>
      <h1 style="color:#fff; font-size:24px; font-weight:bold; margin:0 0 8px 0;">New Contact Message</h1>
    ...
    <div style="padding: 32px 24px;">
        ...
        <div style="margin-bottom:12px;">
          <div style="display:table;width:100%;padding:12px;background:white;border-radius:8px;border:1px solid #e2e8f0;margin-bottom:12px;">
            <div style="display:table-cell;width:40px;vertical-align:middle;">
              <div style="width:32px;height:32px;background:#dbeafe;border-radius:6px;text-align:center;line-height:32px;"><span style="color:#3b82f6;font-size:16px;">👤</span></div>
            </div>
            <div style="display:table-cell;vertical-align:middle;padding-left:12px;">
              ...
              <div style="font-size:14px;font-weight:bold;color:#1a1a1a;">${safeName}</div>
            </div>
          </div>
          <div style="display:table;width:100%;padding:12px;background:white;border-radius:8px;border:1px solid #e2e8f0;margin-bottom:12px;">
            <div style="display:table-cell;width:40px;vertical-align:middle;">
              <div style="width:32px;height:32px;background:#dcfce7;border-radius:6px;text-align:center;line-height:32px;"><span style="color:#059669;font-size:16px;">📧</span></div>
            </div>
            <div style="display:table-cell;vertical-align:middle;padding-left:12px;">
              <div style="font-size:11px;font-weight:bold;color:#64748b;text-transform:uppercase;margin-bottom:2px;">EMAIL</div>
              <a href="mailto:${safeEmail}" style="font-size:14px;font-weight:bold;color:#059669;text-decoration:none;">${safeEmail}</a>
            </div>
          </div>
        </div>
      </div>
      <div style="background:#f8fafc;border-radius:12px;padding:20px;margin-bottom:24px;border:1px solid #e2e8f0;">
        ...
        <div style="background:white;border-radius:8px;padding:16px;border:1px solid #e2e8f0;border-left:3px solid #f59e0b;">
          <div style="color:#374151;font-size:16px;line-height:1.6;font-weight:bold;">${safeSubject}</div>
        </div>
      </div>
      <div style="background:#f8fafc;border-radius:12px;padding:20px;border:1px solid #e2e8f0;">
        ...
        <div style="background:white;border-radius:8px;padding:16px;border:1px solid #e2e8f0;border-left:3px solid #8b5cf6;">
          <div style="color:#374151;font-size:14px;line-height:1.6;">${safeMessage}</div>
        </div>
      </div>
    ...
    <div style="background:#f8fafc;padding:20px 24px;text-align:center;border-top:1px solid #e2e8f0;">
      <div style="color:#64748b;font-size:12px;margin-bottom:8px;">Sent via Portfolio Contact Form</div>
      <div style="color:#94a3b8;font-size:11px;">&copy; ${new Date().getFullYear()} <span style="color:#d4af37;font-weight:bold;">Raghul Kannan</span> • Portfolio</div>
    </div>
  </div>
</body>
</html>
    ...
    await transporter.sendMail({
      ...
      subject: ` New Message - Portfolio Contact from ${safeName}`,
